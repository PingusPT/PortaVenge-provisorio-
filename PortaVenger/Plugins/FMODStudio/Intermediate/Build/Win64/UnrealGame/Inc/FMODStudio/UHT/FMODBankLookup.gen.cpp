...
template<> FMODSTUDIO_API UScriptStruct* StaticStruct<FFMODLocalizedBankTable>()
{
	...
	struct Z_CompiledInDeferFile_FID_Users_Josep_OneDrive_Ambiente_de_Trabalho_Git_PortaVenge_provisorio__PortaVenger_Plugins_FMODStudio_Source_FMODStudio_Private_FMODBankLookup_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Josep_OneDrive_Ambiente_de_Trabalho_Git_PortaVenge_provisorio__PortaVenger_Plugins_FMODStudio_Source_FMODStudio_Private_FMODBankLookup_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Josep_OneDrive_Ambiente_de_Trabalho_Git_PortaVenge_provisorio__PortaVenger_Plugins_FMODStudio_Source_FMODStudio_Private_FMODBankLookup_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Josep_OneDrive_Ambiente_de_Trabalho_Git_PortaVenge_provisorio__PortaVenger_Plugins_FMODStudio_Source_FMODStudio_Private_FMODBankLookup_h_2413627829(TEXT("/Script/FMODStudio"),
		Z_CompiledInDeferFile_FID_Users_Josep_OneDrive_Ambiente_de_Trabalho_Git_PortaVenge_provisorio__PortaVenger_Plugins_FMODStudio_Source_FMODStudio_Private_FMODBankLookup_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Josep_OneDrive_Ambiente_de_Trabalho_Git_PortaVenge_provisorio__PortaVenger_Plugins_FMODStudio_Source_FMODStudio_Private_FMODBankLookup_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Users_Josep_OneDrive_Ambiente_de_Trabalho_Git_PortaVenge_provisorio__PortaVenger_Plugins_FMODStudio_Source_FMODStudio_Private_FMODBankLookup_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Josep_OneDrive_Ambiente_de_Trabalho_Git_PortaVenge_provisorio__PortaVenger_Plugins_FMODStudio_Source_FMODStudio_Private_FMODBankLookup_h_Statics::ScriptStructInfo),
		nullptr, 0);
