...
template<> FMODSTUDIO_API UScriptStruct* StaticStruct<FFMODEventParameterSectionTemplate>()
{
	...
	struct Z_CompiledInDeferFile_FID_Users_Josep_OneDrive_Ambiente_de_Trabalho_Git_PortaVenge_provisorio__PortaVenger_Plugins_FMODStudio_Source_FMODStudio_Private_Sequencer_FMODEventParameterSectionTemplate_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Josep_OneDrive_Ambiente_de_Trabalho_Git_PortaVenge_provisorio__PortaVenger_Plugins_FMODStudio_Source_FMODStudio_Private_Sequencer_FMODEventParameterSectionTemplate_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Josep_OneDrive_Ambiente_de_Trabalho_Git_PortaVenge_provisorio__PortaVenger_Plugins_FMODStudio_Source_FMODStudio_Private_Sequencer_FMODEventParameterSectionTemplate_h_2054165300(TEXT("/Script/FMODStudio"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Users_Josep_OneDrive_Ambiente_de_Trabalho_Git_PortaVenge_provisorio__PortaVenger_Plugins_FMODStudio_Source_FMODStudio_Private_Sequencer_FMODEventParameterSectionTemplate_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Josep_OneDrive_Ambiente_de_Trabalho_Git_PortaVenge_provisorio__PortaVenger_Plugins_FMODStudio_Source_FMODStudio_Private_Sequencer_FMODEventParameterSectionTemplate_h_Statics::ScriptStructInfo),
		nullptr, 0);
